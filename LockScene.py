...
# Validate password based on clues
...
# Visual solving process using backtracking
def solve_visual(clues, target_hash):
    ...
    def draw_status(path, status):
        ...
        info_rect.fill((0, 0, 0, 140))  # 黑色，透明度140/255
...
# Test function
def test_visual_lockscene():
    print("Using clues: [[5, -1, -1], [1, 1]]")
    C = [[5, -1, -1], [1, 1]]
    L = "db6de5887d961f33f38d5d6c79ff706333f2274519c25db5bbded81393c3dfdb"
    solve_visual(C, L)

if __name__ == '__main__':
    test_visual_lockscene()
